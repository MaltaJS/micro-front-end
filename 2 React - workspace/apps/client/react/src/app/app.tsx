...
`}</pre>
      ...
      <div role="navigation">
        <ul>
          ...
          <li>
            <Link to="/feature-details">ReactFeatureDetails</Link>
          </li>
          <li>
            <Link to="/feature-list">ReactFeatureList</Link>
          </li>
          <li>
      ...
      />
      <Route path="/feature-details" component={ReactFeatureDetails} />
      <Route path="/feature-list" component={ReactFeatureList} />
      <Route
        path="/page-2"
        exact
        render={() => (
